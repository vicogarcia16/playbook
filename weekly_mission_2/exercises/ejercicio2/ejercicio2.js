...
console.log("Lista nueva de Stacks: ")
...
console.log("Suma de todos los ejercicios completados por los Explorers")
console.log(suma);
console.log("")
...
console.log("Validación de al menos un explorer tiene true en exercisesFinished:")
console.log(res);
console.log("");
...
console.log("Validación si todos los explorers tienen true en isFinished:")
console.log(res1);
console.log("");